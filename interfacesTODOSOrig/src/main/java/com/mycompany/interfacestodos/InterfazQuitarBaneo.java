 ...
 * @author dobla
 */
public class InterfazQuitarBaneo extends javax.swing.JFrame {

    private BaseDeDatos b;
    /**
     * Creates new form InterfazQuitarBaneo
     */
    public InterfazQuitarBaneo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("QUITAR BANEOS ");
        jLabel1.setAutoscrolls(true);
        jLabel1.setMaximumSize(new java.awt.Dimension(100, 25));

        jLabel2.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        jLabel2.setText("Inserta el correo del usuario que deseas banear: ");
...
//boton para quitar el baneo:    
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        b=new BaseDeDatos();
        String correo = jTextField1.getText().toString();
        if(correo.length()>4) b.QuitarBaneoUsuario(correo);
